...
### This code is part of a submission to ICLR 2020.
...
- [JAX MD Cookbook](https://colab.research.google.com/github/jaxmd/jax-md/blob/master/notebooks/jax_md_cookbook.ipynb)
- [Minimization](https://colab.research.google.com/github/jaxmd/jax-md/blob/master/notebooks/minimization.ipynb)
- [NVE Simulation](https://colab.research.google.com/github/jaxmd/jax-md/blob/master/notebooks/nve_simulation.ipynb)
- [NVT Simulation](https://colab.research.google.com/github/jaxmd/jax-md/blob/master/notebooks/nvt_simulation.ipynb)

Alternatively, you can install JAX, MD by first following the [JAX's](https://www.github.com/jaxmd/jax-md/)
installation instructions. Then installing JAX, MD should be as easy as,

```
git clone https://github.com/jaxmd/jax-md
